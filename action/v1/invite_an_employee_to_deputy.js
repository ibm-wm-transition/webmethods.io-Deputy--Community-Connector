module.exports = {
  ...
  name: "invite_an_employee_to_deputy",

  title: "Invite An Employee To Deputy",
...
var x="https://"+input.auth.subdom+"/api/v1/supervise/employee/"+input.eid+"/invite";
 var y= "Bearer "+input.auth.access_token;
  ...
  try {
		 ...
		 if (response.statusCode === 400) {
            return output("Employee has accepted previous invitation and cannot be re-invited");
        }
